...
%
% Geschrieben im SS 2013 an der TU München
...
\begin{multicols*}{4}
\fstitle{Elektrische Kleinmaschinen}

\input{chapters/grundlagen}
\input{chapters/permanentmagnete}
\input{chapters/gleichstrommaschine}
\input{chapters/wechselfeld}
\input{chapters/synchronmaschine}
\input{chapters/asynchronmaschine}
\input{chapters/universalmaschine}
